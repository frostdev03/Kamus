...
public class FragmentIndonesiaInggris_ViewBinding implements Unbinder {
  private FragmentIndonesiaInggris target;

  @UiThread
  public FragmentIndonesiaInggris_ViewBinding(FragmentIndonesiaInggris target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FragmentIndonesiaInggris target = this.target;
