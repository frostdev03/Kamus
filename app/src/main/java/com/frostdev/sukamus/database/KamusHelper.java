...
import static com.frostdev.sukamus.database.DatabaseContract.KamusColumns.DESKRIPSI;
import static com.frostdev.sukamus.database.DatabaseContract.KamusColumns.KATA;
import static com.frostdev.sukamus.database.DatabaseContract.TABLE_ENGLISH;
import static com.frostdev.sukamus.database.DatabaseContract.TABLE_INDONESIA;
...
public class KamusHelper {
    ...
    public ArrayList<ModelKamus> selectAll(boolean language){
        ...
        if (cursor.getCount()>0) {
            do {
                kamus = new ModelKamus
                        (cursor.getString(cursor.getColumnIndexOrThrow(KATA)),
